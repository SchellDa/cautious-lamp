...
#  EUTELESCOPE_DEFINITIONS - Compiler switches required for using EUTelescope
  ...
  find_path(EUTELESCOPE_INT_PIXEL_INCLUDE_DIR EUTelTrackerDataInterfacer.h
    HINTS "${EUTELESCOPE}/eutelescope/interfaces/pixel/include" "$ENV{EUTELESCOPE}/eutelescope/interfaces/pixel/include")
    
  find_path(EUTELESCOPE_INT_CLUSTER_INCLUDE_DIR EUTelSparseClusterImpl.h
    HINTS "${EUTELESCOPE}/eutelescope/interfaces/cluster/include" "$ENV{EUTELESCOPE}/eutelescope/interfaces/cluster/include")
...
set(EUTELESCOPE_INCLUDE_DIRS ${EUTELESCOPE_LIB_INCLUDE_DIR} ${EUTELESCOPE_INT_PIXEL_INCLUDE_DIR} ${EUTELESCOPE_INT_CLUSTER_INCLUDE_DIR} )
...
find_package_handle_standard_args(EUTelescope  DEFAULT_MSG
                                  EUTELESCOPE_LIBRARY EUTELESCOPE_LIB_INCLUDE_DIR 
				  EUTELESCOPE_INT_PIXEL_INCLUDE_DIR EUTELESCOPE_INT_CLUSTER_INCLUDE_DIR) 
